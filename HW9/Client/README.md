...
------------ | ------------- | ------------- | -------------
*CloudsApi* | [**cancel_cloud_by_id**](docs/CloudsApi.md#cancel_cloud_by_id) | **DELETE** /clouds/{cloud_id} | Cancellation method in cloud by ID
*CloudsApi* | [**create_cloud**](docs/CloudsApi.md#create_cloud) | **POST** /clouds | Create order in cloud
*CloudsApi* | [**get_all_clouds**](docs/CloudsApi.md#get_all_clouds) | **GET** /clouds | Method of getting cloud resource
*CloudsApi* | [**get_cloud_by_id**](docs/CloudsApi.md#get_cloud_by_id) | **GET** /clouds/{cloud_id} | method of getting order by ID
